<table class="contentTable">
    ...
    <tr class="contentTable--tr <?=$l_1?> <?=$l_2?> <?=$l_3?> <?=$l_4?> <?=$l_5?> <?=$status?>">
        ...
        <td class="title"><i class="flaticon-pointer level--url"></i><a href="/panel.php<?=$edit_link?>"><?=$item['title']?></a><a href="/page/<?=$item['url']?>.html" target="_blank"><i class="flaticon-link link--url"></i></a></td>
        <td><?=$item['url']?></td>
        <td>
